...
export default function ListEntregador() {
  ...
  function modalLista(id) {
    axios.get("http://localhost:8080/api/entregador/" + id).then((response) => {
              ...
              <Table.Body>
                {lista.map((entregador) => (
                  <Table.Row key={entregador.id}>
                    ...
                    <Table.Cell>{entregador.ativo === true ? 'Sim' : 'Não'}</Table.Cell>
            ...
            <Table color="orange" celled>
              ...
              <Table.Body>
                <Table.Row key={idDetalhe.id}>
                  ...
                  <Table.Cell>{idDetalhe.ativo === true ? 'Sim' : 'Não'}</Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
          )}
