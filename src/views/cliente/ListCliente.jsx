...
export default function ListCliente() {
  ...
  //Formatação da data para formatação brasileira
                ...
                <Form className="form-filtros">
                  ...
                  <Form.Group widths='equal'>
                    ...
                    icon="search"
                      ...
                      label='Cpf'
                      value={cpf}
                      onChange={(e, { value }) => {handleChangeCpf(value)}}
                    />
                  ...
                  <Table.Row key={cliente.id}>
                    ...
                    <Table.Cell textAlign="center">
                      ...
                      <Button
                        ...
                        circular
                        color="blue"
                        title="Clique aqui para criar um novo endereço"
                        icon
                      >
                        <Link
                      ...
                      <Button
                        ...
                        circular
                        color="purple"
                        title="Clique aqui para ver todos os seus endereços"
                        icon
                      >
                        <Link
